    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white uppercase tracking-wider leading-none mb-6">
          Got A <span className="text-saul-yellow">Hairy Problem?</span>
          <br />
          <span className="text-saul-orange">It's Already Gone.</span>
        </h1>

        {/* Subheadline */}
        <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-10 font-body leading-relaxed">
          The best engineer for hire. Production on fire? Legacy nightmare?
          Impossible deadline? No questions asked. Name the price. Problem disappears.
        </p>
